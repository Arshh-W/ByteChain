import { UploadCloud, ScanFace, FileSearch, Link2, BadgeCheck, LayoutDashboard } from "lucide-react";
...
export const RECENT_UPLOADS = [
  { name: "interview_clip.mp4", meta: "2 hours ago" },
  { name: "news_report.mov", meta: "1 day ago" },
  { name: "press_conference.mp4", meta: "2 days ago" },
];

export const PIPELINE_STEPS = [
  { label: "Extracting Frames", status: "done" },
...
export const KEY_FINDINGS = [
  ...
  { label: "Eye Movement", value: 76 },
  { label: "Lip Sync", value: 69 },
...
export const TREND_DATA = [
  { day: "May 18", value: 6 }, { day: "May 19", value: 9 }, { day: "May 20", value: 7 },
  { day: "May 21", value: 12 }, { day: "May 22", value: 10 }, { day: "May 23", value: 15 },
  { day: "May 24", value: 13 },
];
...
export const RECENT_VERIFICATIONS = [
  { name: "interview_clip.mp4", meta: "May 24, 03:19 PM", score: "24.8%", tone: "rose" },
  { name: "tech_talk.mov", meta: "May 24, 11:10 AM", score: "91.3%", tone: "emerald" },
  { name: "news_report.mp4", meta: "May 22, 08:45 AM", score: "16.6%", tone: "rose" },
  { name: "event_highlights.mov", meta: "May 22, 04:22 PM", score: "87.3%", tone: "emerald" },
];

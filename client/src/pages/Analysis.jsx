      ...
      <div className="col-span-2">
        <Panel>
          <PanelHeader
            step="02"
            title="AI Analysis"
            subtitle="Analyzing image details and patterns"
          />
          <div className="p-8 flex flex-col items-center">
            ...
            />
            <p className="text-xs text-slate-500 mt-6 mb-2 self-start">
              Image Analysis
            </p>
            <div className="flex gap-2 w-full">
              {[0, 1, 2, 3, 4, 5].map((i) => (
                <div
                  ...
                  style={{
                    background: "linear-gradient(135deg,#1e2233,#11131f)",
                  }}
                />
              ))}
            </div>
        ...
        <ul className="space-y-4">
          {PIPELINE_STEPS.map((s) => (
            ...
            >
              <span
                className={
                  s.status === "pending" ? "text-slate-600" : "text-slate-300"
                }
              >
                {s.label}
              </span>

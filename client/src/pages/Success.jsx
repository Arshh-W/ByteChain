      ...
      <Panel className="p-10 max-w-md w-full text-center">
        ...
        <div className="pt-8 pb-4 flex flex-col items-center">
          ...
          <p className="text-slate-100 font-semibold mb-1">
            Record Successfully Stored on Blockchain
          </p>
          <p className="text-xs text-slate-500 mb-6">
            Your verification record is now tamper-proof and publicly
            verifiable.
          </p>
          <div className="w-full text-left text-xs bg-slate-900/60 rounded-xl p-4 border border-slate-800 space-y-2 mb-6">
            <div className="flex justify-between">
              ...
              <span className="text-slate-300">0x7a9b8c...d4e156</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500">Block Number</span>
              <span className="text-slate-300">51124567</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="flex gap-3 w-full">
            <GhostButton onClick={openPolygonScan} className="flex-1">
